            ...
            <section id="footer">
                <div class="row">
                    <div class="large-4 columns">
                        ...
                        <a href="mailto:info@emailaddress.com">info@emailaddress.com</a>
                        <br /> (555) 555-5555
                        <br />
                        <Br />
                    ...
                    <div class="large-4 columns">
                        <div id="newsletter">
                            <span class="yellow">Ready to enroll?</span>
                            <br ?>

                            <input type="text" id="subject" placeholder="You can add a subject" />
                            <br /> Message
                            <br />
                            <textarea id="message" placeholder="Leave a message" rows="7"></textarea>
                            <br />
